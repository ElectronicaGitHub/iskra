...
function RSS (options, items) {
    ...
    this.item = function (options) {
        ...
        var item = {
            ...
            'yandex:full-text': options['yandex:full-text'],
            'yandex:genre':     options['yandex:genre']
        };
...
function generateXML (data){
    ...
    data.items.forEach(function(item) {
        ...
        ifTruePush(item['yandex:full-text'], item_values, { 'yandex:full-text':  { _cdata: item['yandex:full-text'] } });
        ifTruePush(item['yandex:genre'], item_values, { 'yandex:genre': item['yandex:genre']});
